...
import numpy as np
import copy
from DDPG.model.networks import Actor,Critic_MATD3
...
class MATD3(object):
    def __init__(self, args, agent_id):
        ...
        self.action_dim = args.action_dim[agent_id]
        self.lr_a = args.DDPG_v2_lr_a
        self.lr_c = args.DDPG_v2_lr_c
        self.gamma = args.DDPG_v2_gamma
        self.tau = args.DDPG_v2_tau
        self.use_grad_clip = args.DDPG_v2_use_grad_clip
        self.policy_noise = args.DDPG_v2_policy_noise
        self.noise_clip = args.DDPG_v2_noise_clip
        self.policy_update_freq = args.DDPG_v2_policy_update_freq
    ...
    def choose_action(self, obs, noise_std):
        ...
        a = (a + np.random.normal(0, noise_std, size=self.action_dim)).clip(self.action_range[0], self.action_range[1])
    ...
    def train(self, replay_buffer, agent_n):
        ...
        with torch.no_grad():  # target_Q has no gradient
            ...
            for i in range(self.N):
                ...
                batch_a_next = (batch_a_next + noise).clamp(self.action_range[0], self.action_range[1])
