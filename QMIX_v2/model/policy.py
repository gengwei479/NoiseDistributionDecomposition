import torch
from QMIX_v2.model.agent import AgentQFunction
from torch.distributions import Categorical
from QMIX_v2.model.utils import get_dim_from_space, make_onehot, DecayThenFlatSchedule, avail_choose, MultiDiscrete


class QMixPolicy:
    def __init__(self, aeglist, policy_config):
        """
        init relevent args
        """
        self.args = aeglist
        ...
        self.schedule = DecayThenFlatSchedule(self.args.QMIX_v1_epsilon_start, self.args.QMIX_v1_epsilon_finish, self.args.QMIX_v1_epsilon_anneal_time,
                                              decay="linear")
