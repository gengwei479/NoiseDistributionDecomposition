...
class QMixer(nn.Module):
    ...
    def __init__(self, args, device, multidiscrete_list=None):
        ...
        self.use_orthogonal = args.QMIX_v1_use_orthogonal

        self.hidden_layer_dim = args.QMIX_v1_mixer_hidden_dim  # dimension of the hidden layer of the mixing net
        self.hypernet_hidden_dim = args.QMIX_v1_hypernet_hidden_dim # dimension of the hidden layer of each hypernet
        ...
        if args.QMIX_v1_hypernet_layers == 1:
        ...
        elif args.QMIX_v1_hypernet_layers == 2:
