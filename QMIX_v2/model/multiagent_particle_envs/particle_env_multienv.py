...
class ParticleEnvMultiEnv():
    def __init__(self, arglist, is_noise = True):
        ...
        self._env.reset()
        self.agent_ids = [i for i in range(len(self._env.agents))]
...
#     _env = None
#     if arglist.scene_name == "simple_adversary":
#         _env = simple_adversary_v2.parallel_env(continuous_actions = True)
#         arglist.cooperative_agents = [False, True, True]
#     elif arglist.scene_name == "simple_crypto":
#         _env = simple_crypto_v2.parallel_env(continuous_actions = True)
#         arglist.cooperative_agents = [False, True, True]
#     elif arglist.scene_name == "simple_speaker_listener":
#         _env = simple_speaker_listener_v3.parallel_env(continuous_actions = True)
#         arglist.cooperative_agents = [True, True]
#     elif arglist.scene_name == "simple_spread":
#         _env = simple_spread_v2.parallel_env(continuous_actions = True)
#         arglist.cooperative_agents = [True, True, True]
#     elif arglist.scene_name == "simple_reference":
#         _env = simple_reference_v2.parallel_env(local_ratio=0, continuous_actions = True)
#         arglist.cooperative_agents = [True, True]
#     return _env