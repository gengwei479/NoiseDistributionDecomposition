...
from PPO_v1.model.buffer import Buffer
from PPO_v1.model.agent import Agent
...
class Ppo_v1():
    ...
    def save_model(self, arglist):
        ...
        torch.save({'actor_network': self.agent_n.actor.state_dict(), 
                'critic_network': self.agent_n.critic.state_dict()}, 
